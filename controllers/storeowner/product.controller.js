...
module.exports.addProduct = (req, res) => {
  try {
    ...
    q.query(
      "INSERT INTO [Product] (id_store, name, description, id_category, imgLink, price, quantity) VALUES (@id_store, @name, @description, @id_category, @imgLink, @price, @quantity)",
      (err) => {
...
module.exports.modifyProduct = (req, res) => {
  try {
    ...
    q.query(
      "UPDATE [Product] SET name = @name, price = @price, quantity = @quantity, description = @description WHERE id_product = @id_product",
      (err) => {
